...
class Camera3d(object):
    ...
    def __init__(self, pos :Vec3d=Vec3d(0,0,-5), look_at=(0, 0, 0), fov=1200):
        ...
        self.look_at = look_at # to be implemented ;)
...
dt = 0
while(True):
    dt += 1 #todo real time pass
    time.sleep(0.02)
    screen.fill(bgc)

    for _x, o in enumerate(world2):
        x = _x % 10
